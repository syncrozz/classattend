      ...
      <div className="space-y-3">
        ...
        {mySubjectsList.length > 0 ? (
          ...
          <div className="p-8 rounded-2xl bg-slate-900/60 border border-slate-800 text-center space-y-3">
            ...
            <h4 className="text-base font-bold text-white">Anda Belum Menetapkan Subjek Pengajaran</h4>
            <p className="text-xs text-slate-400 max-w-md mx-auto">
              Sistem tidak mengagihkan subjek secara automatik kepada kelas. Anda bebas menentukan subjek apa yang anda ajar daripada senarai 47 kursus kolej dan menetapkan kelas yang berkaitan.
            </p>
            <button
              type="button"
            ...
            >
              <Plus className="w-4 h-4" />
              <span>Pilih Subjek & Kelas Sekarang</span>
            </button>
          </div>
        )}
      </div>
