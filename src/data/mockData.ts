...
export const INITIAL_LECTURERS: Lecturer[] = [
  {
    id: 'LEC-KHAIRI',
    name: 'En. Khairi bin Abdul Rahman',
    email: 'khairi@bpenawar.kpm.edu.my',
    icNumber: '861115-46-5305',
    pin: '5305',
    department: 'Jabatan Pengajian Am',
    assignedSections: ['DIA_4A', 'DIA_4B'],
    assignedSubjects: ['MPU 2163 - Pengajian Malaysia 2', 'QMT 2023 - Statistik Perniagaan'],
    role: 'ADMIN'
  },
  {
    id: 'LEC-ROHANI',
    name: 'Pn. Siti Rohani binti Ahmad',
    email: 'rohani@bpenawar.kpm.edu.my',
    icNumber: '880520-01-5214',
    pin: '5214',
    department: 'Jabatan Perakaunan',
    assignedSections: ['DIA_4A', 'DIA_4C'],
    assignedSubjects: ['ACC 2103 - Perakaunan Kewangan 2'],
    role: 'LECTURER'
  },
  {
    id: 'LEC-FAIZAL',
    name: 'En. Mohd Faizal bin Harun',
    email: 'faizal@bpenawar.kpm.edu.my',
    icNumber: '840912-08-5432',
    pin: '5432',
    department: 'Jabatan Pengurusan Perniagaan',
    assignedSections: ['DIA_4B', 'DIA_4D'],
    assignedSubjects: ['MGT 2013 - Prinsip Pengurusan'],
    role: 'LECTURER'
  },
  {
    id: 'LEC-IZZATI',
    name: 'Pn. Nurul Izzati binti Ismail',
    email: 'izzati@bpenawar.kpm.edu.my',
    icNumber: '910304-01-6128',
    pin: '6128',
    department: 'Jabatan Perakaunan',
    assignedSections: ['DIA_4C', 'DIA_4D'],
    assignedSubjects: ['TAX 3013 - Percukaian Malaysia'],
    role: 'LECTURER'
  }
];
...
export const INITIAL_SUBJECTS: Subject[] = [
  {
    ...
    lecturerName: 'En. Khairi bin Abdul Rahman',
    sections: ['DIA_4A', 'DIA_4B', 'DIA_4C', 'DIA_4D'],
    description: 'Kursus Teras Umum Pengajian Malaysia 2 merangkumi sejarah, perlembagaan, sistem pentadbiran dan integrasi nasional.'
  },
  {
    id: 'SUB-ACC2103',
    code: 'ACC 2103',
    name: 'Perakaunan Kewangan 2',
    lecturerEmail: 'rohani@bpenawar.kpm.edu.my',
    lecturerName: 'Pn. Siti Rohani binti Ahmad',
    sections: ['DIA_4A', 'DIA_4C'],
    description: 'Penyediaan Penyata Kewangan, Pelarasan Akhir Tempoh, dan Piawaian MFRS.'
  },
  {
    id: 'SUB-MGT2013',
    code: 'MGT 2013',
    name: 'Prinsip Pengurusan',
    lecturerEmail: 'faizal@bpenawar.kpm.edu.my',
    lecturerName: 'En. Mohd Faizal bin Harun',
    sections: ['DIA_4B', 'DIA_4D'],
    description: 'Prinsip-prinsip asas pengurusan (POLC), kepimpinan organisasi dan etika pengurusan moden.'
  },
  {
    id: 'SUB-TAX3013',
    code: 'TAX 3013',
    name: 'Percukaian Malaysia',
    lecturerEmail: 'izzati@bpenawar.kpm.edu.my',
    lecturerName: 'Pn. Nurul Izzati binti Ismail',
    sections: ['DIA_4C', 'DIA_4D'],
    description: 'Pengenalan kepada Sistem Percukaian Individu, Perkongsian, Syarikat dan Akta Cukai Pendapatan 1967.'
  }
];
...
export const INITIAL_SESSIONS: AttendanceSession[] = [
  {
    id: 'SES-CLS-MPU2163-01',
    sessionName: 'Kuliah Minggu 4: Perlembagaan Persekutuan & Integriti',
    subjectCode: 'MPU 2163',
    ...
    startTime: '08:30',
    endTime: '10:30',
    status: 'OPEN', // LIVE ACTIVE SESSION
    attendanceMethod: 'QR',
    qrToken: 'TOKEN_MPU2163_WK4',
    location: 'Dewan Kuliah 1',
    topic: 'Struktur Perlembagaan, Hak Asasi & Pengasingan Kuasa',
    createdAt: '2026-08-17T00:30:00.000Z'
  },
  {
    id: 'SES-CLS-ACC2103-01',
    sessionName: 'Kuliah Minggu 4: Penyata Pendapatan Komprehensif',
    subjectCode: 'ACC 2103',
    subjectName: 'Perakaunan Kewangan 2',
    className: 'DIA_4A',
    section: 'DIA_4A',
    lecturerName: 'Pn. Siti Rohani binti Ahmad',
    lecturerEmail: 'rohani@bpenawar.kpm.edu.my',
    ...
    status: 'CLOSED',
    attendanceMethod: 'QR',
    qrToken: 'TOKEN_ACC2103_WK4',
    location: 'Bilik Kuliah 3',
    topic: 'MFRS 101: Presentation of Financial Statements',
    createdAt: '2026-08-17T02:30:00.000Z'
  },
  {
    id: 'SES-CLS-MGT2013-01',
    sessionName: 'Tutorial Minggu 3: Analisis Struktur Organisasi Matriks',
    subjectCode: 'MGT 2013',
    subjectName: 'Prinsip Pengurusan',
    className: 'DIA_4D',
    section: 'DIA_4D',
    lecturerName: 'En. Mohd Faizal bin Harun',
    lecturerEmail: 'faizal@bpenawar.kpm.edu.my',
    ...
    status: 'CLOSED',
    attendanceMethod: 'QR',
    qrToken: 'TOKEN_MGT2013_WK3',
    location: 'Bilik Seminar 2',
    topic: 'Struktur Organisasi & Reka Bentuk Kerja',
    createdAt: '2026-08-15T06:00:00.000Z'
  },
  {
    id: 'SES-CLS-TAX3013-01',
    sessionName: 'Amali Percukaian: Pengiraan Pelepasan Cukai Individu',
    subjectCode: 'TAX 3013',
    subjectName: 'Percukaian Malaysia',
    className: 'DIA_4C',
    section: 'DIA_4C',
    lecturerName: 'Pn. Nurul Izzati binti Ismail',
    lecturerEmail: 'izzati@bpenawar.kpm.edu.my',
    ...
    status: 'CLOSED',
    attendanceMethod: 'QR',
    qrToken: 'TOKEN_TAX3013_WK3',
    location: 'Makmal Komputer 1',
    topic: 'Borang BE LHDN & Pengiraan Rebat',
...
export const INITIAL_ATTENDANCE_RECORDS: AttendanceRecord[] = [
  // Attendance for active class (SES-CLS-MPU2163-01 - DIA_4B)
  { id: 'REC-MPU-01', sessionId: 'SES-CLS-MPU2163-01', studentId: 'PDA-2502-005', timestamp: '2026-08-17T08:32:12.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'MPU 2163', className: 'DIA_4B' },
  { id: 'REC-MPU-02', sessionId: 'SES-CLS-MPU2163-01', studentId: 'PDA-2502-018', timestamp: '2026-08-17T08:34:24.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'MPU 2163', className: 'DIA_4B' },
  { id: 'REC-MPU-03', sessionId: 'SES-CLS-MPU2163-01', studentId: 'PDA-2502-060', timestamp: '2026-08-17T08:36:45.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'MPU 2163', className: 'DIA_4B' },
  { id: 'REC-MPU-04', sessionId: 'SES-CLS-MPU2163-01', studentId: 'PDA-2502-064', timestamp: '2026-08-17T08:37:10.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'MPU 2163', className: 'DIA_4B' },
  { id: 'REC-MPU-05', sessionId: 'SES-CLS-MPU2163-01', studentId: 'PDA-2502-100', timestamp: '2026-08-17T08:38:55.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'MPU 2163', className: 'DIA_4B' },
  { id: 'REC-MPU-06', sessionId: 'SES-CLS-MPU2163-01', studentId: 'PDA-2502-049', timestamp: '2026-08-17T08:39:10.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'MPU 2163', className: 'DIA_4B' },

  // Attendance for past class (SES-CLS-ACC2103-01 - DIA_4A)
  { id: 'REC-ACC-01', sessionId: 'SES-CLS-ACC2103-01', studentId: 'PDA-2502-036', timestamp: '2026-08-17T10:32:10.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'ACC 2103', className: 'DIA_4A' },
  { id: 'REC-ACC-02', sessionId: 'SES-CLS-ACC2103-01', studentId: 'PDA-2502-037', timestamp: '2026-08-17T10:34:22.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'ACC 2103', className: 'DIA_4A' },
  { id: 'REC-ACC-03', sessionId: 'SES-CLS-ACC2103-01', studentId: 'PDA-2502-041', timestamp: '2026-08-17T10:35:40.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'ACC 2103', className: 'DIA_4A' },
  { id: 'REC-ACC-04', sessionId: 'SES-CLS-ACC2103-01', studentId: 'PDA-2502-069', timestamp: '2026-08-17T10:36:12.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'ACC 2103', className: 'DIA_4A' },

  // Attendance for past class (SES-CLS-TAX3013-01 - DIA_4C)
  { id: 'REC-TAX-01', sessionId: 'SES-CLS-TAX3013-01', studentId: 'PDA-2502-004', timestamp: '2026-08-14T08:05:42.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'TAX 3013', className: 'DIA_4C' },
  { id: 'REC-TAX-02', sessionId: 'SES-CLS-TAX3013-01', studentId: 'PDA-2502-016', timestamp: '2026-08-14T08:08:15.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'TAX 3013', className: 'DIA_4C' },
  { id: 'REC-TAX-03', sessionId: 'SES-CLS-TAX3013-01', studentId: 'PDA-2502-022', timestamp: '2026-08-14T08:10:04.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'TAX 3013', className: 'DIA_4C' },
  { id: 'REC-TAX-04', sessionId: 'SES-CLS-TAX3013-01', studentId: 'PDA-2502-092', timestamp: '2026-08-14T08:12:30.000Z', status: 'PRESENT', method: 'QR', subjectCode: 'TAX 3013', className: 'DIA_4C' }
];

// Aliases for compatibility
export const INITIAL_ACTIVITIES = INITIAL_SESSIONS;
